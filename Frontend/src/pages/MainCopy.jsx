...
function MainCopy() {
    ...
    mutationFn: (userVar) => {
      const body = {
        ...
        message: `${user.name} wants help for more details you can call on ${user.phone} 
              the consumer is ${userVar.distance} Km away from your current location`,
      };
  ...
  const {
    data: getNeighbours,
    isFetching: isFetchingNeigh,
    isFetched: isFetchedNeigh,
  } = useQuery({
        ...
        <Navbar>
          ...
          >
            <ModalContent>
              {(onClose) => (
                <>
                  <ModalHeader className="text-text text-2xl font-mono">
                    User Details
                  </ModalHeader>
                  {isFetchedNeigh ? (
                      ...
                      <ModalBody>
                        <Table
                          ...
                          classNames={{
                            ...
                            table:
                              "bg-back shadow-xl shadow-blue-500 rounded-xl",
